<?php update_option('siteurl','http://sigristhomes.com');
    update_option('home','http://sigristhomes.com'); ?>

<!DOCTYPE html>
<html <?php language_attributes(); ?>>
<head>
	<meta charset="<?php bloginfo( 'charset' ); ?>" />
	<title><?php wp_title(''); if(!is_home()) { echo ' | '; echo bloginfo('name'); } else { echo "Sigrist Manufactured Homes"; } ?></title>
